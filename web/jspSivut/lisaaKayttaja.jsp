        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" role="presentation"><a href="lisaaKayttaja.jsp">Lisää Käyttäjä</a></li>
                    <li role="presentation"><a href="lisaaToimenpide.jsp">Lisää Toimenpide</a></li>
                    <li role="presentation"><a href="lisaaToimenpide.jsp">Poista Aloite</a></li>
                    <li role="presentation"><a href="lisaaToimenpide.jsp">Kaikki Aloitteet</a></li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-0">
                    <form action="../../pahvilaatikko/lisaaKayttaja" method="post">
